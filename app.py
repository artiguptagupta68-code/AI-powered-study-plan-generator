...
# ---------------------------
# STEP 1: UPLOAD PDF or USE DEFAULT
# ---------------------------
...
if custom_plan:
    ...
    # Optional: load default syllabus PDFs from EXTRACT_DIR
...
# ---------------------------
# STEP 4: DISPLAY PLAN + DAY COMPLETED
# ---------------------------
